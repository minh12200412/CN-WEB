            ...
            <div class="modal-content">
                <form action="{{ route('store') }}" method="POST">
                    ...
                    <div class="modal-header">
                        ...
                        <a href="{{ route('home') }}"><button type="button" class="close" data-dismiss="modal"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group"><label>Báo cáo sự cố </label><input type="text" id="content"
                                name="reported_by" class="form-control" required>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="modal-footer">
                        <a href="{{ route('home') }}"><input type="button" class="btn btn-default" data-dismiss="modal"
                                value="Cancel"></a>
