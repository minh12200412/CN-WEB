            ...
            <div class="modal-content">
                <form action="{{ route('update', $students->id) }}" method="POST">
                    ...
                    <div class="modal-header">
                        ...
                        <a href="{{ route('home') }}"><button type="button" class="close" aria-hidden="true">&times;
                            </button></a>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group"><label>Báo cáo sự cố </label><input type="text" id="content"
                                name="reported_by" class="form-control" value="{{$students->reported_by}}" required>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="datetime-local" id="reported_date" name="reported_date" class="form-control"
                                value="{{ $students->reported_date }}" required>
                        </div>
                        <div class="form-group">
